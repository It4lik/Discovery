...
namespace discovery
{
    class Program
    {
        ...
        {   
            ...
            HostAction actionIfUp = new HostAction(HostAction.ActionType.SSHExec, "177.177.1.21", 2222, "john", "dbc", "echo \"<HOST> became UP at <TIME>\"  >> ZALU");
            // Action to do if a host is down
            HostAction actionIfDown = new HostAction(HostAction.ActionType.SSHExec, "177.177.1.21", 2222, "john", "dbc", "echo \"<HOST> became DOWN at <TIME>\"  >> ZALU");
